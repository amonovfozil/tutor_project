...
class Reviews_part extends StatefulWidget {
  final List reviews;
  const Reviews_part({required this.reviews, super.key});

  @override
  State<Reviews_part> createState() => _Reviews_partState();
}

class _Reviews_partState extends State<Reviews_part> {
  bool init = true;
  int ReviewsIndex = 2;
  final List Reviews = [];
