// ignore_for_file: prefer_typing_uninitialized_variables, non_constant_identifier_names, prefer_const_literals_to_create_immutables
...
class TeaCCHatScreen extends StatefulWidget {
  const TeaCCHatScreen({super.key});

  @override
  State<TeaCCHatScreen> createState() => _TeaChatScreenState();
}

class _TeaChatScreenState extends State<TeaCCHatScreen> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (index != null) ChatField(teacherData!, []),
      ],
    );
  }
}
